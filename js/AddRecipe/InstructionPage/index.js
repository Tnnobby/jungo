...
export default function InstructionPage ({saveRecipe, ...props}) {
  const xOffset = useRef(new Animated.Value(Dimensions.get('screen').width)).current;
  ...
  return (
    <Animated.View style={styles.main}>
        <Text style={{...GeneralStyles.header, color: constants.primary_color}}>Ingredients</Text>
          <View style={styles.ingredientContainer}>
            <IngredientManager />
          </View>
        <Text style={{...GeneralStyles.header, color: constants.primary_color}}>Instructions</Text>
        <View>
          <InstructionManager />
        </View>
